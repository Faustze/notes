...
> Мемоизированная функция — это функция, которая никогда не вызывается дважды с одинаковыми входными данными.
> Вместо этого она возвращает закэшированное значение.
...
> Учтите, что если значение уже закэшировано для аргументов (b, a), где a != b, оно не может быть использовано для аргументов (a, b).
