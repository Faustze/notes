...
> Дан целочисленный массив nums, отсортированный по неубыванию, верните массив квадратов каждого числа, отсортированный по неубыванию.
> Ограничения: - 1 <= nums.length <= 10^4 - -10^4 <= nums[i] <= 10^4 - nums отсортирован по неубыванию.
> Дополнительно: возвести каждый элемент в квадрат и отсортировать новый массив — тривиально, сможете ли вы найти решение за O(n) другим способом?
