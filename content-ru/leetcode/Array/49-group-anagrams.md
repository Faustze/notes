...
> Пример 1: Ввод: ['eat','tea','tan','ate','nat','bat'] Вывод: [['bat'],['nat','tan'],['eat','tea','ate']] Объяснение: ...
> Пример 2: Ввод: [''] Вывод: [['']] Объяснение: ...
> Пример 3: Ввод: ['a'] Вывод: [['a']] Объяснение: ...
...
[[leetcode/Hash Table/242-valid-anagram|242 — проверка одной анаграммы]]
#leetcode
