...
> К сожалению, из-за ошибки одно из чисел в `s` продублировалось вместо другого числа набора, из-за чего одно число повторилось, а другое было потеряно.
> Дан целочисленный массив nums, представляющий состояние данных этого набора после ошибки.
