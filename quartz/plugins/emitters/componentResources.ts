...
// @ts-ignore
import dappledCanvasScript from "../../components/scripts/dappled-canvas.inline"
...
function addGlobalPageResources(ctx: BuildCtx, componentResources: ComponentResources) {
  ...
  // dappled canvas (tree-dappled light effect on index page)
  componentResources.afterDOMLoaded.push(dappledCanvasScript)
