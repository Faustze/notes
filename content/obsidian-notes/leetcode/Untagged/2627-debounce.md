...
> For example, if t = 50ms and the function was called at 30ms, 60ms, and 100ms, the first 2 function calls would be cancelled, and the 3rd function call would be executed at 150ms.
